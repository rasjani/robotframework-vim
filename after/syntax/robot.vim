...
syn match requestsLibrary           "\c\<\(Create Client Cert Session\|Create Custom Session\|Create Digest Session\|Create Ntlm Session\|Create Session\|Delete\|Delete All Sessions\|Delete Request\|Get\|Get Request\|Head\|Head Request\|Options\|Options Request\|Patch\|Patch Request\|Post\|Post Request\|Put\|Put Request\|To Json\|Update Session\)\>"
syn match fakerLibrary              "\c\<\(Add Provider\|Address\|Am Pm\|Ascii Company Email\|Ascii Email\|Ascii Free Email\|Ascii Safe Email\|Bank Country\|Bban\|Binary\|Boolean\|Bothify\|Bs\|Building Number\|Catch Phrase\|Century\|Chrome\|City\|City Prefix\|City Suffix\|Color Name\|Company\|Company Email\|Company Suffix\|Coordinate\|Country\|Country Code\|Credit Card Expire\|Credit Card Full\|Credit Card Number\|Credit Card Provider\|Credit Card Security Code\|Cryptocurrency\|Cryptocurrency Code\|Cryptocurrency Name\|Currency\|Currency Code\|Currency Name\|Date\|Date Between\|Date Between Dates\|Date Object\|Date Of Birth\|Date This Century\|Date This Decade\|Date This Month\|Date This Year\|Date Time\|Date Time Ad\|Date Time Between\|Date Time Between Dates\|Date Time This Century\|Date Time This Decade\|Date Time This Month\|Date Time This Year\|Day Of Month\|Day Of Week\|Domain Name\|Domain Word\|Ean\|Ean 13\|Ean 8\|Ein\|Email\|File Extension\|File Name\|File Path\|Firefox\|First Name\|First Name Female\|First Name Male\|Format\|Free Email\|Free Email Domain\|Future Date\|Future Datetime\|Generator Format Token\|Get Formatter\|Get Providers\|Hex Color\|Hexify\|Hostname\|Iban\|Image Url\|Init\|Internet Explorer\|Ipv 4\|Ipv 6\|Ipv4 Network Class\|Ipv4 Private\|Ipv4 Public\|Isbn 10\|Isbn 13\|Iso 8601\|Itin\|Job\|Language Code\|Last Name\|Last Name Female\|Last Name Male\|Latitude\|Latlng\|Lexify\|License Plate\|Linux Platform Token\|Linux Processor\|Local Latlng\|Locale\|Location On Land\|Longitude\|Mac Address\|Mac Platform Token\|Mac Processor\|Md 5\|Military Apo\|Military Dpo\|Military Ship\|Military State\|Mime Type\|Month\|Month Name\|Msisdn\|Name\|Name Female\|Name Male\|Null Boolean\|Numerify\|Opera\|Paragraph\|Paragraphs\|Parse\|Password\|Past Date\|Past Datetime\|Phone Number\|Postalcode\|Postalcode In State\|Postalcode Plus4\|Postcode\|Postcode In State\|Prefix\|Prefix Female\|Prefix Male\|Profile\|Provider\|Pybool\|Pydecimal\|Pydict\|Pyfloat\|Pyint\|Pyiterable\|Pylist\|Pyset\|Pystr\|Pystruct\|Pytuple\|Random Choices\|Random Digit\|Random Digit Not Null\|Random Digit Not Null Or Empty\|Random Digit Or Empty\|Random Element\|Random Elements\|Random Int\|Random Letter\|Random Letters\|Random Lowercase Letter\|Random Number\|Random Sample\|Random Uppercase Letter\|Randomize Nb Elements\|Rgb Color\|Rgb Css Color\|Safari\|Safe Color Name\|Safe Email\|Safe Hex Color\|Secondary Address\|Seed Instance\|Sentence\|Sentences\|Set Formatter\|Sha 1\|Sha 256\|Simple Profile\|Slug\|Ssn\|State\|State Abbr\|Street Address\|Street Name\|Street Suffix\|Suffix\|Suffix Female\|Suffix Male\|Text\|Time\|Time Delta\|Time Object\|Time Series\|Timezone\|Tld\|Unix Device\|Unix Partition\|Unix Time\|Uri\|Uri Extension\|Uri Page\|Uri Path\|Url\|User Agent\|User Name\|Uuid 4\|Windows Platform Token\|Word\|Words\|Year\|Zipcode\|Zipcode In State\|Zipcode Plus4\)\>"
syn match appiumLibrary             "\c\<\(Background App\|Capture Page Screenshot\|Clear Text\|Click A Point\|Click Button\|Click Element\|Click Element At Coordinates\|Click Text\|Close All Applications\|Close Application\|Element Attribute Should Match\|Element Name Should Be\|Element Should Be Disabled\|Element Should Be Enabled\|Element Should Be Visible\|Element Should Contain Text\|Element Should Not Contain Text\|Element Text Should Be\|Element Value Should Be\|Execute Async Script\|Execute Script\|Get Activity\|Get Appium SessionId\|Get Appium Timeout\|Get Capability\|Get Contexts\|Get Current Context\|Get Element Attribute\|Get Element Location\|Get Element Size\|Get Matching Xpath Count\|Get Network Connection Status\|Get Source\|Get Text\|Get Webelement\|Get Webelements\|Get Window Height\|Get Window Width\|Go Back\|Go To Url\|Hide Keyboard\|Input Password\|Input Text\|Input Value\|Install App\|Landscape\|Launch Application\|Lock\|Log Source\|Long Press\|Long Press Keycode\|Open Application\|Page Should Contain Element\|Page Should Contain Text\|Page Should Not Contain Element\|Page Should Not Contain Text\|Pinch\|Portrait\|Press Keycode\|Pull File\|Pull Folder\|Push File\|Quit Application\|Register Keyword To Run On Failure\|Remove Application\|Reset Application\|Scroll\|Scroll Down\|Scroll Up\|Set Appium Timeout\|Set Location\|Set Network Connection Status\|Shake\|Start Activity\|Swipe\|Swipe By Percent\|Switch Application\|Switch To Context\|Tap\|Text Should Be Visible\|Toggle Touch Id Enrollment\|Touch Id\|Wait Activity\|Wait Until Element Is Visible\|Wait Until Page Contains\|Wait Until Page Contains Element\|Wait Until Page Does Not Contain\|Wait Until Page Does Not Contain Element\|Xpath Should Match X Times\|Zoom\)\>"
syn match restInstanceLibrary       "\c\<\(Array\|Boolean\|Clear Expectations\|Delete\|Expect Request\|Expect Response\|Expect Response Body\|Get\|Head\|Input\|Integer\|Missing\|Null\|Number\|Object\|Options\|Output\|Output Schema\|Patch\|Post\|Put\|Rest Instances\|Set Client Cert\|Set Headers\|String\)\>"
...
syn match ftpLibrary                "\c\<\(Cwd\|Delete\|Dir\|Dir Names\|Download File\|Ftp Close\|Ftp Connect\|Get All Ftp Connections\|Get Welcome\|Mkd\|Pwd\|Rename\|Rmd\|Send Cmd\|Size\|Upload File\)\>"
